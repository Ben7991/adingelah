        ...
        <div class="row">
            <div class="col-12 col-md-8 col-xl-7 col-xxl-6">
                <div class="border rounded bg-white shadow-sm p-3">
                    <h5 class="mt-0 mb-3">Add Program</h5>
                    <form id="programForm" action="{{ route("program-initiative.store") }}" method="post">
                        @csrf
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="time" name="time" value="{{ old("time") }}" id="time" class="form-control">
                            @error("time")
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
