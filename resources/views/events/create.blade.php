                ...
                <div class="border rounded bg-white shadow-sm p-3">
                    ...
                    <form id="eventForm" action="{{ route("events.store") }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="datetime-local" value="{{ old("event_date") }}" name="event_date" id="event_date" class="form-control">
                            @error('event_date')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group mb-3">
                            ...
                            <input type="text" value="{{ old("venue") }}" name="venue" id="venue" class="form-control">
                            @error('venue')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
